...
class Leg:
    ...
    def rotate_femur(self, ang):
        ...
        if (self.__angs[0] <= 90):
            self.__end_point[0] = (self.L0 + dxy) * math.cos(self.__angs[0])
            self.__end_point[1] = (self.L0 + dxy) * math.sin(self.__angs[0])
        else:
            self.__end_point[0] = -(self.L0 + dxy) * math.sin(self.__angs[0] - 90)
            self.__end_point[1] = (self.L0 + dxy) * math.cos(self.__angs[0] - 90)
        ...
        if (self.__angs[0] <= 90):
            self.__tibia_point[0] = (self.L0 + dxy) * math.cos(self.__angs[0])
            self.__tibia_point[1] = (self.L0 + dxy) * math.sin(self.__angs[0])
        else:
            self.__tibia_point[0] = -(self.L0 + dxy) * math.sin(self.__angs[0] - 90)
            self.__tibia_point[1] = (self.L0 + dxy) * math.cos(self.__angs[0] - 90)
    ...
    def rotate_tibia(self, ang):
        ...
        ss = math.sqrt(self.L1 * self.L1 + self.L2 * self.L2 - 2 * self.L1 * self.L2)
        u = (ss * ss + self.L1 * self.L1 - self.L2 * self.L2) / 2 / ss / self.L1
        v = math.acos(u) * 180 / math.pi
...
def update_pos(tick, coord_syst_lines, leg_lines, point_annotation):
    global creature, legs, coord_system, steps, pause
